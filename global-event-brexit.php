            ...
            <div class="bg">
                ...
                <div class="globaleventcontent">
                    ...
                    <div class="globaleventfacts">
                        ...
                        <ul>
                            <li class="data">Über 4'000 EU-Gesetze müssen im UK-Gesetzbuch angepasst, übernommen oder gestrichen werden</li>
                            <li class="data">Vermehrt lange Wartezeiten für Facht und Passagiere an den Fährhäfen Calais und Dover</li>
                            <li class="data">Investitionsabfluss aus Grossbritannien, speziell im Bereich Automobil-Industrie, da Automobile unter Umständen nicht mehr zollfrei in die EU eingeführt werden können.</li>
                            <li class="data">Verlust des Freedom of Services führt zu Mehraufwand und Kosten für Dienstleister</li>
                            <li class="data">Laut Bloomberg kostet Brexit Grossbritannien bis zu 100 Milliarden pro Jahr</li>
                        </ul>
                    </div>
                </div>
            </div>
