...
<head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# place: http://ogp.me/ns/place#">
    ...
    <link rel="canonical" href="https://funk-global-risk-consensus.com/naturkatastrophen" />
...
<body>
    ...
    <div class="rdmain">
        <div class="rdeinleitung">
            ...
            <div class="item40 bg">
                ...
                <canvas id="entwicklung-naturkatastrophen"></canvas>
        ...
        <div class="rdcontainer">
            ...
            <div class="rdcfakten">
                ...
                <div class="fakten bg">
                    <h1>Schadenreichste Erdbeben seit 1980</h1>
                    <p>Die folgende Grafik zeigt die 5 grössten Erdbeben gemessen an Ihrer Schadenssumme sowie des versicherten Schadens.</p>
                    <div class="mchartscont">
                        <div class="mchartsbig">
                            <canvas id="nk-grafik-01"></canvas>
                        </div>
                    </div>
                    <p class="dquelle">Source: Munich Re NatCatSERVICE</p>
                </div>
            </div>
    ...
    <script src="naturkatastrophen.js"></script>
